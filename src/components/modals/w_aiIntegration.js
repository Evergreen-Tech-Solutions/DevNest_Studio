    ...
    <Modal open={open} onClose={onClose} className="flex items-center justify-center p-4">
      <Box sx={boxStyle}>
        ...
        <div className="bg-lght rounded-md p-2 mt-3 mb-2">
          ...
          <Typography sx={subStyle}>Personalized User Experience:</Typography>
          <Typography sx={textStyle}>
          ...
          <Typography sx={subStyle}>Advanced Data Analytics and Insights:</Typography>
          <Typography sx={textStyle}>
          ...
          <Typography sx={subStyle}>AI-Powered Chatbots and Virtual Assistants:</Typography>
          <Typography sx={textStyle}>
          ...
          <Typography sx={subStyle}>Computer Vision and Image Recognition:</Typography>
          <Typography sx={textStyle}>
          ...
          <Typography sx={subStyle}>Natural Language Processing (NLP):</Typography>
          <Typography sx={textStyle}>
          ...
          <Typography sx={subStyle}>AI Strategy & Use Case Identification:</Typography>
          <Typography sx={textStyle}>
          ...
          <Typography sx={subStyle}>Machine Learning Model Development:</Typography>
          <Typography sx={textStyle}>
          ...
          <Typography sx={subStyle}>Integration with Existing Systems:</Typography>
          <Typography sx={textStyle}>
          ...
          <Typography sx={subStyle}>Testing & Validation:</Typography>
          <Typography sx={textStyle}>
          ...
          <Typography sx={subStyle}>Deployment and Optimization:</Typography>
          <Typography sx={textStyle}>
          ...
          <Typography sx={subStyle}>Ongoing Learning and AI Model Training:</Typography>
          <Typography sx={textStyle}>
